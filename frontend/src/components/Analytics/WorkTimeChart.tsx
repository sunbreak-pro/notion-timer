...
import { aggregateByDay, aggregateByWeek, aggregateByMonth } from '../../utils/analyticsAggregation';
      ...
      <div className="h-48">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 4, right: 8, left: -16, bottom: 0 }}>
            <CartesianGrid strokeDasharray="3 3" stroke="var(--color-notion-border, #e5e5e5)" />
            <XAxis
              dataKey="label"
            ...
            <Tooltip
              ...
              formatter={(value: number) => [`${value}h`, t('analytics.workTime')]}
            />
            <Bar dataKey="hours" fill="var(--color-notion-accent, #2563eb)" radius={[4, 4, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
